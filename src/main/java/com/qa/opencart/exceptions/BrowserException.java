...
/**
 * BrowserException is a custom runtime exception that is thrown when an error related to browser operations occurs.
 * It extends the RuntimeException class, allowing unchecked exceptions to be thrown and caught.
 */
public class BrowserException extends RuntimeException {

    /**
     * Constructs a new BrowserException with the specified detail message.
     * 
    ...
    /**
     * OOP Concepts Used:
     * - Inheritance: BrowserException inherits from RuntimeException, which is part of Java's exception hierarchy.
     * - Polymorphism: By extending RuntimeException, BrowserException can be used polymorphically wherever exceptions are handled.
     * 
     * Access Modifiers:
     ...
     *    - Provides a specific exception type for browser-related errors, improving the granularity of error handling in the application.
     * 
     * 2. **Inheritance**:
